...
function Select() {
  return (
    <div className='flex flex-col h-[100%] w-[100%] justify-center items-center'>
      ...
      <button className='h-10 w-52 text-xl font-roboto bg-[#714CC2] hover:bg-[#8257E5] rounded-md xl border border-x-1 border-y-1 border-solid border-[#16161d] shadow-xl text-white shadow-[#714CC2]'>
            Select
      </button>
